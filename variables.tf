...
variable "config_recorder_excluded_resource_types" {
  description = "List of resource types to exclude from Config Recorder (used with EXCLUSION strategy)"
  type        = string
...
variable "config_recorder_included_resource_types" {
  description = "List of resource types to include in Config Recorder (used with INCLUSION strategy)"
  type        = string
  default     = "AWS::S3::Bucket,AWS::CloudTrail::Trail"
}

variable "config_recorder_daily_resource_types" {
  description = "List of resource types to record at daily cadence"
  type        = string
...
variable "config_recorder_daily_global_resource_types" {
  description = "List of global resource types to record daily in the Control Tower home region"
  type        = string
